...
(function(Opal) {
  ...
  Opal.Object.$$proto.$usage = function(msg) {
    ...
    self.$puts(msg);
    self.$puts("vrbjs - A ruby source runner/transpiler via VRbJS in JavaScriptCore\n\n");
    self.$puts("Usage:");
    self.$puts("vrbjs [OPTIONs] [PATH|CODE]\n\n");
    self.$puts("OPTIONS:");
...
if (k == null) k = nil;if (v == null) v = nil;
  ...
  Opal.cdecl($scope, 'PROGRAM', $scope.get('Program').$new());
    ...
    if ((($a = ($b = opts['$[]']("E")['$!']()['$!'](), $b !== false && $b !== nil ?opts['$[]']("w")['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
      $gvars.stderr.$puts("OptionsError: -E without -w is useless");
      $scope.get('VRbJS').$exit(1);};
    if ((($a = ($b = opts['$[]']("U")['$!']()['$!'](), $b !== false && $b !== nil ?opts['$[]']("w")['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
      $gvars.stderr.$puts("OptionsError: -U without -w is useless");
      $scope.get('VRbJS').$exit(1);};
    ...
    } else if ((($a = $scope.get('ARGV')['$empty?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
      $gvars["0"] = "(file)";
      parser = true;
...
if (a == null) a = nil;
      ...
      return $scope.get('PROGRAM').$run(code, opts['$[]']("w")['$!']()['$!'](), parser, opts['$[]']("D")['$!']()['$!'](), opts['$[]']("E")['$!']()['$!'](), $gvars["0"], opts['$[]']("r"), ((($a = opts['$[]']("U")) !== false && $a !== nil) ? $a : false));
      } else {
      return self.$usage("Requires at least one argument")
    };
